...
exports.commands = {
	...
	tierpoll: function (target, room, user) {
		...
		this.parse('/poll Tier for the next tournament?, Haxmons, Super Staff Bros, Random Battle, Anything Goes, Ubers, OverUsed, Underused, RarelyUsed, NeverUsed, PU, LC, Random Doubles Battle, VGC 2016, Battle Spot Doubles, Random Triples Battle, Challenge Cup 1v1, Challenge Cup 2v2, Balanced Hackmons, 1v1, Monotype, Monotype Random Battle, Inverse Battle, Almost Any Ability, STABmons, Hackmons Cup, [Seasonal], Battle Factory, Doubles OU, CAP, Gen 5 OU');
	},
